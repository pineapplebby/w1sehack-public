...
import me.wise.w1sehack.api.utils.Timer;
import me.wise.w1sehack.api.utils.chat.ChatMessage;
import me.wise.w1sehack.api.utils.chat.ChatUtils;
import me.wise.w1sehack.api.utils.player.InventoryUtils;
import me.wise.w1sehack.api.utils.render.RenderUtil;
...
extends Module {
    ...
    Value<Color> outline = new ValueBuilder().withDescriptor("Outline").withValue(new Color(0, 0, 0, 0)).register(this);
    Value<Color> fill = new ValueBuilder().withDescriptor("Fill").withValue(new Color(148, 0, 211, 81)).register(this);
    BlockPos breaking;
