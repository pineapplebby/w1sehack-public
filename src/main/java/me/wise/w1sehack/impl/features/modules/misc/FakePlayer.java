...
extends Module {
    ...
    public FakePlayer() {
        super("FakePlayer", Feature.Category.Misc);
    ...
    public void onEnable() {
        ...
        this.fakePlayer = new EntityOtherPlayerMP((World)FakePlayer.mc.world, new GameProfile(UUID.fromString("8d5951a3-907b-49c1-96b4-04adcb59f58c"), "w1secheat"));
