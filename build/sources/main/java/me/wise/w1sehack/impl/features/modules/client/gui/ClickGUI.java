 ...
 */
package me.wise.w1sehack.impl.features.modules.client.gui;
...
import me.wise.w1sehack.api.utils.MathUtil;
import me.wise.w1sehack.api.utils.NullUtils;
import me.wise.w1sehack.api.utils.color.ColorUtil;
import me.wise.w1sehack.api.utils.render.font.CFontRenderer;
...
import me.wise.w1sehack.api.gui.widget.impl.ComboBoxWidget;
...
implements IColorScheme,
    ...
    Value<Color> mainColor = new ValueBuilder().withDescriptor("Color").withValue(new Color(148, 0, 211)).register(this);
    ...
    Value<Color> outlineColor = new ValueBuilder().withDescriptor("Outline").withValue(new Color(0, 0, 0, 0)).register(this);
    Value<Color> frameOutline = new ValueBuilder().withDescriptor("Frame Outline").withValue(new Color(0, 0, 0, 82)).register(this);
    Value<Boolean> fancyBooleans = new ValueBuilder().withDescriptor("Fancy Booleans").withValue(true).register(this);
    Value<Number> height = new ValueBuilder().withDescriptor("Height").withValue(12.67).withRange(8, 20).register(this);
    Value<Number> width = new ValueBuilder().withDescriptor("Width").withValue(111.03).withRange(60, 200).register(this);
    ...
    public void renderBindWidget(BindWidget widget, Context context, Rect rect, MouseHelper mouse) {
        ...
        String text = widget.isBinding() ? "Binding..." : "Bind: " + ChatFormatting.WHITE + keyName;
    ...
    public int getTextWidth(String text) {
        return FontModule.INSTANCE.isEnabled() ? fontRenderer.getStringWidth(text) + (text.equals("-") ? 2 : 0) : ClickGUI.mc.fontRenderer.getStringWidth(text);
    }

    @Override
    public int getTextHeight(String text) {
        return FontModule.INSTANCE.isEnabled() ? fontRenderer.getStringHeight(text) + 1 : ClickGUI.mc.fontRenderer.FONT_HEIGHT;
    }
    ...
    public void renderText(String text, float x, float y, Color color, boolean shadow) {
        if (FontModule.INSTANCE.isEnabled()) {
            ...
            ClickGUI.mc.fontRenderer.drawStringWithShadow(text, x, y, color.getRGB());
        } else {
            ClickGUI.mc.fontRenderer.drawString(text, (int)x, (int)y, color.getRGB());
        }
    }
